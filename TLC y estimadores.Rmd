...
#numeric crea un vector que se llama proporciones de longitud (n_lanzamientos_max)
```
...
Si n tiende a infitnito, podemos obtener una distribución normal por el TCL
```{r}
x30 <- c()
x100 <- c()
x1000 <- c()
